...
d0 = 280.0 # degrees counterclockwise from North
...
vman.params.dirErrMax = np.deg2rad(-0.1)
print("direction error threshold: "+str(vman.params.dirErrMax))

## Initialize UAV
#planner = PathPlanner(vman) # instantiate planner, Floris v. Floris
planner = PathPlanner(vman, xBar) # instantiate planner object, Floris v. SOWFA
...
planner.plotHistory([uav], None, True) # don't save the animation, show the plot
